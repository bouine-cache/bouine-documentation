...
| **Comprendre le fonctionnement interne** | [Architecture →](architecture/) |
...
- [Configuration](configuration/) — référence YAML, politique de cache, tiers de stockage, TLS, clustering et valeurs du chart Helm.
- [Exploitation](operations/) — cycle de vie, invalidation, supervision, dashboard, opérations Kubernetes et dépannage.
- [Architecture](architecture/) — conception en couches, moteur de cache, stockage, clustering et performance.
- [Guides](guides/) — migration depuis Varnish ou NGINX, exemples de reverse proxy et capacity planning.
- [Contribuer](contributing/) — workflow des contributeurs, carte du code et sécurité.
